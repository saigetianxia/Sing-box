...
export UUID=${UUID:-'5b2efb18-f551-4d63-9c4b-45cba8ce43b5'}
...
quick_command() {
  ...
  echo "bash <(curl -Ls https://raw.githubusercontent.com/saigetianxia/Sing-box/test/sb_00.sh)" >> "$SCRIPT_PATH"
  chmod +x "$SCRIPT_PATH"
